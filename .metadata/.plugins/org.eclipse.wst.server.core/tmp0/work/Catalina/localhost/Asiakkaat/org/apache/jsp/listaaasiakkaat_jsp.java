 ...
 * Generated at: 2020-04-30 16:53:11 UTC
...
public final class listaaasiakkaat_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<th class=\"nappi\"><input type=\"button\" value=\"HAE\" id=\"hakunappi\"></th>\r\n");
      out.write("\t\t</tr>\t\t\t\t\t\t\r\n");
      out.write("\t\t<tr>\r\n");
      ...
      out.write("\t\t$.ajax({url:\"asiakkaat/\"+id, type:\"DELETE\", dataType:\"json\", success:function(result) { //result on joko {\"response:1\"} tai {\"response:0\"}\r\n");
      out.write("\t        if(result.response==0){\r\n");
      out.write("\t        \t$(\"#ilmo\").html(\"Asiakkaan poisto epäonnistui.\");\r\n");
      out.write("\t        }else if(result.response==1){\r\n");
      out.write("\t        \t$(\"#rivi_\"+id).css(\"background-color\", \"red\"); //Värjätään poistetun asiakkaan rivi\r\n");
